This directory contains various tasks on python test driven development. They include;
...
*Task 6 (Advanced): Write a function that multiplies 2 matrices:
...
*Task 7 (Advanced): Write a function that multiplies 2 matrices by using the module NumPy
...
*Task 8 (Advanced): Create a function that prints Python strings.
